...
defaultSleepTime=100	# milliseconds
...
# constants
java_main_class="pgpersist.TestBasicLog"
java_main_class="experiment.LiveRun"
...
script=/tmp/$0.sh
echo "java -Xmx$javamem -cp $classpath $java_main_class $serverPort $sleep_time_ms | tee -a $logfile" > $script
