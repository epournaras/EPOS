...
//import org.apache.commons.collections15.Transformer; //TODO ask Jovan
import org.apache.commons.collections4.Transformer;

import com.google.common.base.Function;

//Non-problematic library
//
...
public class GraphLogger<V extends DataType<V>> extends AgentLogger<TreeAgent<V>> {
    ...
    private Line getEdgeShapeTransformer() {    	
    		//TODO confirm that my changes are still runnable
    ...
    private Function<Node, Paint> getVertexFillPaintTransformer() {
        return (Node vertex) -> {
            return new Color(vertex.val, vertex.val, vertex.val);
        };
    }

    private Function<Node, Shape> getVertexShapeTransformer() {
        return (Node vertex) -> {
