...
// this is the experiment class for the FGCS paper, where you can configure and test different dynamics

public class LivePeerTestbedExperiment extends ZMQExperiment {
