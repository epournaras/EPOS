 ...
 *
 */
public class ConfigurableExperiement {
	...
	private static void runOneSimulation(Configuration config, Function<Integer, Agent> createAgent) {
        ...
        ConfigurableExperiement.runSimulation(Configuration.numChildren,
	...
	public static void main(String[] args) {
		...
		Configuration config = ConfigurableExperiement.generateConfiguration(args);    	
    	LoggingProvider<MultiObjectiveIEPOSAgent<Vector>> loggingProvider = 
    								ConfigurableExperiement.generateLoggers(config);
		...
		for(int sim = 0; sim < Configuration.numSimulations; sim++) {
			...
			ConfigurableExperiement.runOneSimulation(config, createAgent);
		}
